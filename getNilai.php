<?php
    ...
    if(!function_exists('getNilaiZikri')){
        ...
        function getNilaiZikri($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US001' AND Periode = '$Periode'");
    ...
    if(!function_exists('getNilaiFillah')){
        ...
        function getNilaiFillah($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US002' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiMeilizka')){
        ...
        function getNilaiMeilizka($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US003' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiKendanan')){
        ...
        function getNilaiKendanan($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US004' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiAlya')){
        ...
        function getNilaiAlya($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US005' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiBayu')){
        ...
        function getNilaiBayu($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US006' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiRegis')){
        ...
        function getNilaiRegis($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US007' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiRevaldy')){
        ...
        function getNilaiRevaldy($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US008' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
    ...
    if(!function_exists('getNilaiRangga')){
        ...
        function getNilaiRangga($koneksi, $Periode){
            ...
            $queryGetNilai = mysqli_query($koneksi, "SELECT SUM(TJPeran) AS TJPeran, SUM(TepatHadir) AS TepatHadir, SUM(Keaktifan) AS Keaktifan, SUM(Inisiatif) AS Inisiatif, SUM(Sikap) AS Sikap, SUM(Komunikasi) AS Komunikasi FROM nilai WHERE ID_UserIn = 'US009' AND Periode = '$Periode'");
            while($data = mysqli_fetch_array($queryGetNilai)){
